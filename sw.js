const CACHE='fenice-palco-v44-2627-20260812';
const ASSETS=['./','./index.html','./calendario_generale.html','./fenice_2627_data.json','./manifest.json','./icon-192-v2.png','./icon-512-v2.png'];
